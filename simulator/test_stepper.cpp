...
void test_single_stepper_speeds(AVRTimerSimulator * sim) {
    ...
    motor1.setImmediateSpeed(1000);
    sim->simulate(2); // 2 seconds
    
    //motor1.setTargetSpeed(3000);
    motor1.setImmediateSpeed(3000);
...
void test_multiple_steppers() {
    ...
    StepperContinuous motor1(2, 3);   // STEP=2, DIR=3
    StepperContinuous motor2(4, 5);   // STEP=4, DIR=5
    StepperContinuous motor3(6, 7);   // STEP=6, DIR=7
    ...
    motor2.setTargetSpeed(500);
    motor3.setTargetSpeed(1000);
